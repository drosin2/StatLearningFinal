...
#We might not need to do this, since we are fitting a forest based on death, this may be biased on proximity? I dont think so though
...
```
#Medical intensive care unit vs surgical intensive care unit, both seem to have similar distributions and a non-zero number of outliers
...
```
13.7 percent of our patients admitted into the ICU were outliers (214 patients in our dataset)
...
plot(temp)
```
#many other variables additionally had impacts on decision. Though less severe than abg count, resp_flg (respiratory infection) also resulted in a small increase in the predicted length of stay.
...
99/1677 *100
```
5.90% of patients in the data set had liver disease. This likely means sensativity will be off. 
